...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://clubtecnicosdimacof.site/api/';
  }
  ...
  @override
  Future<List<VentaIntermediada>> getVentasIntermediadasSolicitudes(
      String idTecnico) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/ventasIntermediadasSolicitud/${idTecnico}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  @override
  Future<SolicitudCanjeDetalles> obtenerSolicitudCanjeDetalles(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SolicitudCanjeDetalles>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SolicitudCanjeDetalles.fromJson(_result.data!);
    return value;
  }

  @override
  Future<Map<String, dynamic>> eliminarSolicitudCanje(
      String idSolicitudCanje) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/solicitudes-canje/delete/${idSolicitudCanje}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<List<TecnicoNotification>> getNotifications(String idTecnico) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<TecnicoNotification>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            TecnicoNotification.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
